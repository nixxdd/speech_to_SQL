...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.8\textwidth]{assets/speech_to_SQL_diagram.jpg}
...
% Correction can be done by the user through our custom UI to both the generated SQL query and the transcribed text. 
